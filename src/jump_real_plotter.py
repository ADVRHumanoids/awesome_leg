...
path = "/media/andreap/AP_backup/awesome_leg_IROS23_data/awesome_leg_tests/final_jump_energy_recov/real_hardware/backup_jump_tests/jump_generation_24-02-2023-12_13_45"
power_data = "test_bus_power_rt__4_2023_02_28__14_47_58"
replay_data = "test_traj_replay__2_2023_02_28__14_47_58"
path_opt = "/media/andreap/AP_backup/awesome_leg_IROS23_data/opt_jumps/promising_jumps/refinement_motivation/jump_generation_24-02-2023-12_13_45"
...
# f1.title()
ax[0].plot(selected_time_replay, selected_q_dot_meas[0, :], drawstyle='steps-post')
ax[0].plot(selected_time_replay, selected_q_dot_meas[1, :], drawstyle='steps-post')
...
ax[1].plot(selected_time_pow, selected_iq_meas[0, :], drawstyle='steps-post')
ax[1].plot(selected_time_pow, selected_iq_meas[1, :], drawstyle='steps-post')
# ax1.plot(selected_time_replay, selected_iq_meas[0, :], drawstyle='steps-post')
# ax[1].set_xlabel('time',  fontsize=fontsize)
ax[1].set_ylabel('[A]', fontsize=fontsize)
ax[1].set_title('Quadrature currents - hardware test', fontsize=fontsize)
ax[1].grid()
legend = ax[1].legend([r"$i_{q0}$", r"$i_{q1}$"], fontsize=fontsize)
legend.set_draggable(state = True)
ax[2].plot(selected_time_replay, selected_tau_meas[0, :], drawstyle='steps-post')
ax[2].plot(selected_time_replay, selected_tau_meas[1, :], drawstyle='steps-post')
# ax1.plot(selected_time_replay, selected_iq_meas[0, :], drawstyle='steps-post')
ax[2].set_xlabel('time [s]',  fontsize=fontsize)
ax[2].set_ylabel('[Nm]', fontsize=fontsize)
ax[2].set_title('Joint efforts - hardware test', fontsize=fontsize)
ax[2].grid()
legend = ax[2].legend([r"$\tau_{1}$", r"$\tau_{2}$"], fontsize=fontsize)
legend.set_draggable(state = True)
f1.set_figheight(5)
f1.set_figwidth(10)
...
# f1.title()
ax32[0].plot(time_vect_opt, opt_data["q_p_dot"][0, :-1], drawstyle='steps-post')
ax32[0].plot(time_vect_opt, opt_data["q_p_dot"][1, :-1], drawstyle='steps-post')
...
ax32[1].plot(time_vect_opt, opt_data["i_q"][0, :], drawstyle='steps-post')
ax32[1].plot(time_vect_opt, opt_data["i_q"][1, :], drawstyle='steps-post')
# ax1.plot(selected_time_replay, selected_iq_meas[0, :], drawstyle='steps-post')
# ax[1].set_xlabel('time',  fontsize=fontsize)
...
legend.set_draggable(state = True)
ax32[2].plot(time_vect_opt, opt_data["tau"][1, :], drawstyle='steps-post')
ax32[2].plot(time_vect_opt, opt_data["tau"][2, :], drawstyle='steps-post')
# ax1.plot(selected_time_replay, selected_iq_meas[0, :], drawstyle='steps-post')
ax32[2].set_xlabel('time [s]',  fontsize=fontsize)
