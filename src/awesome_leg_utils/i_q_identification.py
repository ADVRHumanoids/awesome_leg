...
# Model description
urdf_path = rospkg.RosPack().get_path("awesome_leg")+"/description/urdf/awesome_leg_RBDL.urdf"   # urdf absolute path (remember RBDL might have some problems parsing the first link, if it has not a d.o.f.)
srdf_path = rospkg.RosPack().get_path("awesome_leg")+"/description/srdf/awesome_leg_RBDL.srdf"   # srdf absolute path
...
i_q_hip_time, i_q_hip_measured = log_loader.extr_from_aux(jnt_id = 1, sgnl_name = 'iq_out_fb_aux_code')
i_q_knee_time, i_q_knee_measured = log_loader.extr_from_aux(jnt_id = 2, sgnl_name = 'iq_out_fb_aux_code')
