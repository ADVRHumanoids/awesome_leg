...
config_path = rospkg.RosPack().get_path("awesome_leg")+"/config/"
...
# opt_res_path = rospkg.RosPack().get_path("awesome_leg")+ "/opt_results/horizon_trot/fixed_hip"  # optimal results absolute path
...
matfile_path = rospkg.RosPack().get_path("awesome_leg")+'/test_results/fixed_hip_setup/trot/fixed_hip_ample_trot/'+'robot_state_log__0_2022_01_24__17_14_01.mat' # path to the used .mat file holding the test results
# matfile_path = rospkg.RosPack().get_path("awesome_leg")+'/test_results/fixed_hip_setup/cyclic_tests/large_excursion/slow/'+'robot_state_log__0_2022_01_26__16_47_58.mat' # slow cyclic test
# matfile_path = rospkg.RosPack().get_path("awesome_leg")+'/test_results/fixed_hip_setup/cyclic_tests/large_excursion/fast/'+'robot_state_log__0_2022_01_26__16_49_17.mat' # fast cyclic test
# matfile_path = rospkg.RosPack().get_path("awesome_leg")+'/test_results/fixed_hip_setup/cyclic_tests/large_excursion/faster/'+'robot_state_log__0_2022_01_26__16_50_32.mat' # faster cyclic test

# matfile_path = rospkg.RosPack().get_path("awesome_leg")+'/test_results/fixed_hip_setup/system_identification/'+'robot_state_log__0_2022_01_26__16_49_17.mat' 
