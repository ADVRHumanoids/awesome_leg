...
class fullJumpGen:
    ...
    def __init__(self, yaml_path: str, actuators_yaml_path: str, 
                urdf_path: str,
                results_path: str,
                sol_mat_name =  "full", sol_mat_name_res = "full_res", sol_mat_name_ref = "full_ref",   
                cost_epsi = 1.0, 
                yaml_tag = "full_gen", 
                is_ref_prb = False, 
                load_ig = True, 
        ...
        self.dt_touchdown_name = "dt_touchdown"
    ...
    def __read_opts_from_yaml(self):
        ...
        if not self.is_ref_prb:
            ...
            self.touchdown_node = self.yaml_file[self.yaml_tag]["problem"]["touchdown_node"]
    ...
    def __load_ig(self):
        ...
        self.touchdown_node = int(np.round(touchdown_time/dt_res))
