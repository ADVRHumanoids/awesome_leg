...
ax[0].plot(selected_time_pow, selected_iq_est[0, :], drawstyle='steps-post')
ax[0].plot(selected_time_pow, selected_iq_meas[1, :], drawstyle='steps-post')
...
ax[1].plot(selected_time_replay, selected_tau_meas[0, :], drawstyle='steps-post')
ax[1].plot(selected_time_replay, selected_tau_meas[1, :], drawstyle='steps-post')
ax[1].set_xlabel('time [s]',  fontsize=fontsize)
ax[1].set_ylabel('[Nm]', fontsize=fontsize)
...
ax2[1].set_ylabel(r"[A]" + " - " +  r"[Nm]", fontsize = fontsize)
...
ax32[3].plot(time_vect_opt, opt_data["foot_tip_height"][:-1], drawstyle='steps-post')
ax32[3].plot(time_vect_opt, opt_data["com_pos"][2, :-1], drawstyle='steps-post')
...
ax32[4].plot(time_vect_opt, opt_data["f_contact"][0, :], drawstyle='steps-post')
ax32[4].plot(time_vect_opt, opt_data["f_contact"][1, :], drawstyle='steps-post')
ax32[4].plot(time_vect_opt, opt_data["f_contact"][2, :], drawstyle='steps-post')
