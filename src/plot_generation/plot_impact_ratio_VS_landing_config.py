...
plt.xlabel(r"$q_1$ [rad]", fontsize=10)
plt.ylabel(r"$\rho$ [$\mathrm{N\,s^2}/\mathrm{m}$]", fontsize=10)
plt.title("Impact ratio VS landing configuration", fontdict=None, loc='center', fontsize=10)
ax = plt.gca()
# ax.set_aspect(0.05)
plt.grid()
plt.show()
