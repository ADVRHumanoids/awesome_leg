...
namespace BT
{
    ...
    class TakeoffPerformed : public ConditionNode, public Task
    {
        public:

            // You must provide the function to call when tick() is invoked
            TakeoffPerformed(const std::string& name, const NodeConfiguration& config);

            ~TakeoffPerformed() override = default;
