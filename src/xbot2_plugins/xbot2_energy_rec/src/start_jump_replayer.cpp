...
class CyclicJumpTrig
{
    public:
        ...
        void start_client(std::string full_topicname = "/jmp_replayer_rt/jump_now_srv")
        {
        ...
        {
            _sub = _nh->subscribe("/jmp_replayer_rt/replay_status_node", 1000, &CyclicJumpTrig::replay_status_callback, this);
        }
